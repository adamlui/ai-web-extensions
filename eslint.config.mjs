    ...
    { ignores: ['**/*cache*', '**/*.min.{css,js,mjs}', '**/package-lock.json'] },
    {
        ...
        languageOptions: {
            ...
            globals: {
                ...
                chrome: 'readonly', CryptoJS: 'readonly', css: 'readonly', deepseek: 'readonly', dom: 'readonly',
                env: 'writable', feedback: 'readonly', fontSizeSlider: 'writable', get: 'readonly',
                GM_cookie: 'readonly', hljs: 'readonly', i18n: 'readonly', icons: 'writable', importScripts: 'readonly',
                infinity: 'readonly', JSON5: 'readonly', ipv4: 'readonly', log: 'readonly', logos: 'readonly',
                marked: 'readonly', menus: 'writable', modals: 'writable', notify: 'readonly', prompts: 'readonly',
