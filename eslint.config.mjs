    ...
    { ignores: ['**/*.min.js', '**/package-lock.json', '**/rising-particles/'] },
    {
        ...
        languageOptions: {
            ...
            globals: {
                ...
                get: 'readonly', GM_cookie: 'readonly', hljs: 'readonly', icons: 'writable', importScripts: 'readonly',
                infinity: 'readonly', JSON5: 'readonly', ipv4: 'readonly', log: 'readonly', marked: 'readonly',
