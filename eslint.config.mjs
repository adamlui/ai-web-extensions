...
export default [
    { ignores: ['**/*cache', '**/*.min.{js,mjs}', '**/package-lock.json', '**/rising-particles/'] },
    {
        files: ['**/*.{js,mjs}'],
        languageOptions: {
            ...
            globals: {
                ...
                icons: 'writable', importScripts: 'readonly', infinity: 'readonly', inputEvents: 'readonly',
                JSON5: 'readonly', ipv4: 'readonly', log: 'readonly', logos: 'readonly', marked: 'readonly',
                menus: 'writable', modals: 'writable', notify: 'readonly', prompts: 'readonly',
